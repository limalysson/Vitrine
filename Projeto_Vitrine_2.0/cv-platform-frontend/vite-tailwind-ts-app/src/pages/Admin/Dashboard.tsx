  ...
  return (
    <main className="w-full max-w-7xl mx-auto px-4 py-8 animate-fade-in-up">
      ...
      <header className="card-default-large mb-8 border-indigo-500/20">
         ...
         <div className="relative z-10 w-full mt-6 bg-slate-900/50 p-4 rounded-xl border border-white/5 flex flex-wrap gap-2 items-center justify-between">
            ...
            <button onClick={copyLandingPageLink} className="home-button-card !py-2 !px-4 text-sm !from-indigo-600 !to-indigo-500 shadow-indigo-500/20">
              ...
              <article key={curriculum._id} className="card-default-large !p-5 transition-all duration-300 hover:border-indigo-500/30">
                 <div className="flex flex-col lg:flex-row justify-between lg:items-center gap-4 border-b border-white/5 pb-4 mb-4">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                       ...
                       <div className="flex border border-white/10 rounded-lg overflow-hidden bg-slate-900/50">
                          <button 
                            onClick={() => handleStatusChange(curriculum._id, "ativo")}
                            disabled={curriculum.status === 'ativo'}
                            className={`px-3 py-1.5 text-xs font-semibold uppercase transition-colors ${curriculum.status === 'ativo' ? 'bg-emerald-500/20 text-emerald-400 opacity-50 cursor-not-allowed' : 'text-slate-300 hover:bg-emerald-500/20 hover:text-emerald-400'}`}
                          >
                             Aprovar
                          </button>
                          <button 
                            ...
                            className={`px-3 py-1.5 text-xs font-semibold uppercase border-l border-white/5 transition-colors ${curriculum.status === 'pendente' ? 'bg-amber-500/20 text-amber-400 opacity-50 cursor-not-allowed' : 'text-slate-300 hover:bg-amber-500/20 hover:text-amber-400'}`}
                          >
                             Pendente
                          </button>
                          <button 
                            ...
                            className={`px-3 py-1.5 text-xs font-semibold uppercase border-l border-white/5 transition-colors ${curriculum.status === 'inativo' ? 'bg-rose-500/20 text-rose-400 opacity-50 cursor-not-allowed' : 'text-slate-300 hover:bg-rose-500/20 hover:text-rose-400'}`}
                          >
                             Inativar
                          </button>
                       </div>
                 ...
                 <div className="border-t border-white/5 pt-3 mt-2">
                    <button 
                      ...
                      className="w-full text-center text-xs text-slate-400 hover:text-white flex items-center justify-center gap-1 py-1"
                    >
